...
class TestBoggle(unittest.TestCase):
    ...
    def test_grid_coordinates(self):
        """
        Test to ensure that all coordinated inside the grid
        can be accessed
        """
    ...
    def test_all_grid_neighbours(self):
        """
        Ensure that all grid positions have neighbourser
        """
    ...
    def test_search_grid_for_words(self):
        """
        Ensure that certain patterns can be found in sa path_to_word
        """
    ...
    def test_load_dictionar(self):
        """
        Test that the get_dictionary function
        returns a dictionary that has a length greater than 0
        """
